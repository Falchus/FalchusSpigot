...
##### FalchusSpigot is a 1.8.8 Minecraft server software focused on improving overall server performance and pvp mechanics based on a **[fork of WindSpigot](https://github.com/Wind-Development/WindSpigot)**.
